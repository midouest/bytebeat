...
function(sc_add_server_plugin dest_dir name inc_dir cpp sc schelp)
    if(SCSYNTH)
        set(sy_name "${name}_scsynth")
        add_library(${sy_name} MODULE "${cpp}")
        target_include_directories(${sy_name} PRIVATE ${inc_dir})
    ...
    if(SUPERNOVA)
        ...
        target_include_directories(${sn_name} PRIVATE ${inc_dir})
